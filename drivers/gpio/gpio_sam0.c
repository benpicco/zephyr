...
static void gpio_sam0_isr(u32_t pins, void *arg)
{
	...
	_gpio_fire_callbacks(&data->callbacks, dev, pins);
}
#endif
...
/* Port D */
#ifdef DT_GPIO_SAM0_PORTD_BASE_ADDRESS

static const struct gpio_sam0_config gpio_sam0_config_3 = {
	.regs = (PortGroup *)DT_GPIO_SAM0_PORTD_BASE_ADDRESS,
};

DEVICE_AND_API_INIT(gpio_sam0_3, DT_GPIO_SAM0_PORTD_LABEL, gpio_sam0_init,
